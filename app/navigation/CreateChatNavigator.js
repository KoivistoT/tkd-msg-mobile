...
const CreateChatNavigator = () => (
  ...
  >
    <Stack.Group>
      <Stack.Screen
        options={{ title: "Create chat", headerTitleAlign: "center" }}
        name="create_new_chat_screen"
        component={MemoCreateNewChatScreen}
      />
      <Stack.Screen
        options={{ title: "Create channel", headerTitleAlign: "center" }}
        name="create_channel_screen"
        component={MemoCreateChannelScreen}
      />
      <Stack.Screen
        options={{ title: "Create group", headerTitleAlign: "center" }}
