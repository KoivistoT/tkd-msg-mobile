...
const ARCHIVED_TEXT = appMessages.notifications.ROOM_IS_ARCHIVED;
...
function MessageForm({ item }) {
  ...
  const showMessageFrom = () => {
    if (currentRoomType === "private" && !isOtherUserActive) {
      return false;
    }

    return currentRoomStatus === "active" || currentRoomStatus === "draft";
  };
